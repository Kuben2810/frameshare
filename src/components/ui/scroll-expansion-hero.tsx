            ...
            <div className='flex flex-col items-center justify-center w-full h-[100dvh] relative'>
              ...
              >
                ...
                <div className='flex flex-col items-center text-center relative z-10 mt-4 transition-none'>
                  {date && (
                    <p
                      className='text-xl sm:text-2xl text-white font-oswald uppercase tracking-widest font-semibold drop-shadow-md'
                  ...
                  {scrollToExpand && (
                    <p
                      className='text-white/80 font-mono text-xs uppercase tracking-widest mt-1 text-center drop-shadow-md'
                      style={{ transform: `translateX(${textTranslateX}vw)` }}
                    >
                      {scrollToExpand}
                    </p>
              ...
              >
                <motion.h2
                  className='text-4xl md:text-6xl lg:text-7xl font-bold text-white font-oswald uppercase tracking-wide transition-none drop-shadow-lg'
                  style={{ transform: `translateX(-${textTranslateX}vw)` }}
                >
                  {firstWord}
                </motion.h2>
                <motion.h2
                  className='text-4xl md:text-6xl lg:text-7xl font-bold text-center text-white font-oswald uppercase tracking-wide transition-none drop-shadow-lg'
                  style={{ transform: `translateX(${textTranslateX}vw)` }}
                >
                  {restOfTitle}
                </motion.h2>
